...
subprojects {
    ...
    configure<MavenPublishBaseExtension> {
        ...
        pom {
            ...
            url.set("https://github.com/aSoft-Ltd/bee")
            licenses {
                license {
                    name.set("MIT License")
                    url.set("https://github.com/aSoft-Ltd/bee/blob/master/LICENSE")
                }
            }
            developers {
                developer {
            ...
            scm {
                url.set("https://github.com/aSoft-Ltd/bee/")
                connection.set("scm:git:git://github.com/aSoft-Ltd/bee.git")
                developerConnection.set("scm:git:ssh://git@github.com/aSoft-Ltd/bee.git")
            }
        }
    }
}
